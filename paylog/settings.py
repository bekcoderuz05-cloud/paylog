...
SIMPLE_JWT = {
    ...
    # Tokenni yangilash (rotate) qilinsa, eski token invalid boâ€˜ladi
...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-ctb4r$l)%uusaf3sowkdpz87zty(nz7m)8+=+7%cf2l8l-*aws")
...
TEST_DELETE_ENABLED = os.getenv("TEST_DELETE_ENABLED", "false").lower() in ("1", "true", "yes")
TEST_DELETE_PHONE = os.getenv("TEST_DELETE_PHONE", TEST_LOGIN_PHONE)
